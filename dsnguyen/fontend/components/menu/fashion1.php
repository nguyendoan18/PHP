<?php
    ...
    $sql = "SELECT * FROM dsnguyen_tintuc where dsnguyen_loaitin = 5 and dsnguyen_id NOT IN( SELECT MAX(dsnguyen_id) FROM dsnguyen_tintuc WHERE dsnguyen_loaitin = 5) ORDER BY dsnguyen_id DESC limit 4";
